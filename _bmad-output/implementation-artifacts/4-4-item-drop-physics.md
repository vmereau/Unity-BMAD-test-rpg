...
- 2026-03-14: Right-click direct-drop behavior (AC 4, ItemSlotUI.OnPointerClick → InventoryUI.DropItem) superseded by Story 4.8 which introduces a context menu. The drop action is preserved as a menu option. No code rollback needed — Story 4.8 modifies ItemSlotUI and InventoryUI directly.
